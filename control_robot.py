...
try:
    ...
    while sim.simxGetConnectionId(clientID) != -1:
        ...
        if quadrant_timer > quadrant_timeout:
            ...
            quadrant_timer = 0.0
            # Opcional: você pode implementar aqui algum reset no CoppeliaSim ou mudar meta
            # Por simplicidade, continua normalmente com a mesma meta
        ...
        # Ativa Braitenberg se DWA travar
